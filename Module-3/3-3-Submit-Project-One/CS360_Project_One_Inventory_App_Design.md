...
I used an AI assistant to help organize this analysis, review wording, and pull
accurate references from my own GitHub repositories. I chose the app, drew the
connections to my warehouse experience and prior projects, and verified every claim
about those projects against my actual repositories.
